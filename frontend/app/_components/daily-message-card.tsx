    ...
    <>
      ...
      <section
        ...
        className="
          ...
          bg-white
          p-4
          shadow-[0_12px_30px_rgba(11,52,36,0.07)]
          sm:p-5
        "
      >
        <div
        ...
        <p
          ...
          "
        >
          Abra a mensagem do dia no popup e use o botão
          de recarregar para ver outra frase.
        </p>
          ...
          >
            <motion.div
              ...
              className="
                ...
                bg-white
                p-6
                shadow-[0_22px_56px_rgba(0,0,0,0.24)]
              "
              initial={{
                y: 20,
                opacity: 0,
              ...
              >
                <div>
                  ...
                  <p
                    ...
                    "
                  >
                    Clique em fechar ou recarregar para
                    atualizar.
                  </p>
                </div>
